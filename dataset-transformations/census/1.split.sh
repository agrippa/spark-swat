...
${HADOOP_HOME}/bin/hdfs dfs -put $SPARK_DATASETS/census/1.converted/* /input/

spark-submit --class CensusSplitter \
...
rm -rf $SPARK_DATASETS/census/2.split
${HADOOP_HOME}/bin/hdfs dfs -get /converted $SPARK_DATASETS/census/2.split
