...
object Tuple2OutputTest extends CodeGenTest[Int, (Int, Int)] {
  def getExpectedKernel() : String = {
    ...
    "__kernel void run(\n" +
    "      __global int* in0, \n" +
    "      __global scala_Tuple2_I_I* out, __global void *heap, __global uint *free_index, long heap_size, __global int *processing_succeeded, __global int *any_failed, int N) {\n" +
